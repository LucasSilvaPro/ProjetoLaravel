<?php /* /home/lucas/curLaravel/resources/views/cursos.blade.php */ ?>
		...
		<div class='cursos1'><br><br><br>
			<center>
				...
				<?php $__currentLoopData = $cursos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $curso): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>			
				 	<tr>
				 		<td><center><?php echo e($curso->getId()); ?></center></td>
				 		<td><center><?php echo e($curso->getNome_Curso()); ?></center></td>
				 		<td><center><?php echo e($curso->getStatus_Curso()); ?></center></td>
				 		<td><center>
				 			<form action="<?php echo e(route('atualizar' , $curso->getId())); ?>" >
								<div class='uk-margin'>
					       			<div class='uk-inline'>
					    		...
					    		<input type="hidden" name="<?php echo e($curso->getId()); ?>">
					    		<div class='uk-margin'>
					       			<div class='uk-inline'>
				 		...
				 		<td>
				 		<center>				 			
							<a href="<?php echo e(route('apagarCurso',$curso->getId())); ?>"><button class='uk-button uk-button-default'>Apagar</button></a>		        			</td>
						</center>
				 	</tr>
